            ...
            <fieldset>
                ...
                <div class="fieldset-content">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" name="email" id="email" maxlength="100" value="{{ old('email') }}" />
                        <span class="text-input">Example :<span> sandro@email.com</span></span>
                    </div>
                    <div class="form-group">
                        <label for="cpf" class="form-label">CPF</label>
                        <input type="text" name="cpf" id="cpf" data-mask-cpf value="{{ old('cpf') }}"/>
                    </div>
                    <div class="form-date">
                        ...
                        <div class="form-date-group">
                            ...
                            <div class="form-date-item">
                                <select id="birth_year" name="birth_year" value="{{ old('birth_year') }}"></select>
                        ...
                        <div>
                            <div class="radio-container">
                                <label for="gender-mas">
                                    <input type="radio" id="gender-mas" name="gender" value="M" checked />
                            ...
                            <div class="radio-container">
                                <label for="gender-fem">
                                    <input type="radio" id="gender-fem" name="gender" value="F" />
                                    <div class="custom-radio">
                                        <span></span>
                                    </div>
                                    <span>Feminino</span>
